...
export default function ConnectPopup({ popupShowed, setPopupShowed, className }) {
    return (
        <Popup popupShowed={popupShowed} setPopupShowed={setPopupShowed} className={className}>
                ...
                <ul className="popup__buttons">
                    ...
                    <li className="popup__buttons-item">
                        <button className="popup__button">
                            ...
                            <img src={wc} alt="WalletConnect" className="popup__button-icon" />
                        </button>
                    </li>
                </ul>
