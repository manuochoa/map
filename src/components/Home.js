...
function Home({
  ...
  return (
    <div className="main main--home">
      <div className="map map--home">
        <Link to="/" className="link link--main">
          <img
            src={mainLogo}
            alt="wennie land"
            className="link__title"
            aria-label='wennie land"'
          />
        </Link>
        <a
          href="https://pancakeswap.finance/swap?outputCurrency=0x9edccffbfa09be9ae65bfb1352965ba184ab4c09"
          className="link link--buy"
          target="_blank"
          rel="noreferrer"
        >
          <img
            ...
            alt="buy weland"
            className="link__title"
            aria-label="buy weland"
          />
        </a>
        {!userAddress && (
          <button
            className="link link--connectWallet"
            onClick={() => setPopupShowed(!popupShowed)}
          >
            <img
              src={connectWallet}
              alt="connect wallet"
        ...
        <button
          className="link link--market"
          onClick={() => setMarketShowed(true)}
        >
          <img
            src={market}
            alt="market"
        ...
        <Link to="/" className="link link--portal">
          <img
            src={portal}
            alt="portal for the unknown"
            className="link__title"
            aria-label="portal for the unknown"
          />
        </Link>
      ...
      />
      <MarketPopup
        popupShowed={marketShowed}
        setPopupShowed={setMarketShowed}
        className="popup--market"
      />
    </div>
  );
}
